...
public class studentLogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        customerPass = new javax.swing.JPasswordField();
        ...
        Submit.setFont(new java.awt.Font("Kristen ITC", 0, 14)); // NOI18N
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(jPanel1Layout.createSequentialGroup()
                                        ...
                                        .addGap(28, 28, 28)
                                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                            .addComponent(customerId, javax.swing.GroupLayout.DEFAULT_SIZE, 164, Short.MAX_VALUE)
                                            .addComponent(customerPass)))))
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGap(132, 132, 132)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(customerPass, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(53, 53, 53)
    ...
    private void SubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SubmitActionPerformed
        // TODO add your handling code here:
           String query="SELECT * FROM `Customers` WHERE `Customer Id`=? and `Password`=SHA1(?)";//apply sha1
     try {//System.out.println("can i be here");
         ps=con.prepareStatement(query);
        // System.out.println("yes you can");
         ps.setString(1,customerId.getText());
         ps.setString(2,(String)customerPass.getText());
         rs= ps.executeQuery();
         //System.out.println("i m here again");
         if(rs.next()){
             //s_id=5;
            setVisible(false);
       Home ob = new Home(Integer.parseInt(customerId.getText()));
      // ob.setupLoading();
       ob.setVisible(true);
         }
         else{
    ...
    private javax.swing.JPasswordField customerPass;
